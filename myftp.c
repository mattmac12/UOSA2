...
void helpMenu()
{
	...
	printf("cd - Change the current directory of the server to a specified directory.\n");
	printf("lcd - Change your current directory to the specified directory.\n");
	printf("gets - Download the file with specified filename from the servers current directory.\n");
	printf("puts - Upload the file with specified filename from your current directory to the server.\n");
